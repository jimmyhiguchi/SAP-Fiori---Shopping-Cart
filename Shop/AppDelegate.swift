...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // below added for OAuth to verify log in
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        launchManager.manageAppLaunch { onboardingResult, onboardingError, loginResult in self.launch(onboardingResult: onboardingResult, onboardingError: onboardingError, loginResult: loginResult)
        }
    ...
    func launch(onboardingResult: StandardOAuthFlowResult?, onboardingError: StandardOAuthFlowError?, loginResult: StandardLoginFlowResult?) {
        ...
        if let navigationController = self.window?.rootViewController as? UINavigationController,
            let productListViewController = navigationController.viewControllers.first as? ProductListViewController { productListViewController.loadProducts()
